...
class RetrievalChain(ABC):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        Args:
            **kwargs: Keyword arguments including:
                ...
                embedding_model: Model name for embeddings (default: Ollama "llama3.1:latest")
                persist_directory: Directory to persist vector store
        """

        self.source_uri = kwargs.get("source_uri", [])
        self.k = kwargs.get("k", 5)
        self.embedding_model = kwargs.get("embedding_model", "llama3.1:latest")
    ...
    def split_documents(
        self, docs: List[Document], text_splitter: Any
    ) -> List[Document]:
        """
    ...
    def create_embedding(self) -> Any:
        """
        Create an embedding model instance (Ollama).
    ...
    def create_hybrid_retriever(
        self, split_docs: List[Document], vectorstore: Any
    ) -> BaseRetriever:
        """
